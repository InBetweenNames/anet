diff -ruN anet/src/dp/dpio.c anet.linux/src/dp/dpio.c
--- anet/src/dp/dpio.c	Wed Mar 10 04:01:18 1999
+++ anet.linux/src/dp/dpio.c	Mon Mar 15 15:07:59 1999
@@ -2222,7 +2222,12 @@
 	pw = &pc->tx;
...
diff -ruN anet/src/dp/enumsrv2.c anet.linux/src/dp/enumsrv2.c
--- anet/src/dp/enumsrv2.c	Wed Mar 10 04:01:22 1999
+++ anet.linux/src/dp/enumsrv2.c	Mon Mar 15 17:23:05 1999
@@ -752,7 +752,7 @@
...
Binary files anet/src/dp/t.o and anet.linux/src/dp/t.o differ
diff -ruN anet/src/linux/dp/dpdll.c anet.linux/src/linux/dp/dpdll.c
--- anet/src/linux/dp/dpdll.c	Wed Mar 10 04:01:35 1999
+++ anet.linux/src/linux/dp/dpdll.c	Fri Mar 12 16:04:59 1999
@@ -6,6 +6,9 @@
...
diff -ruN anet/src/linux/dp/makefile anet.linux/src/linux/dp/makefile
--- anet/src/linux/dp/makefile	Wed Mar 10 04:01:37 1999
+++ anet.linux/src/linux/dp/makefile	Wed Apr 28 02:44:30 1999
@@ -4,13 +4,13 @@
...
+	#$(CC) -shared -static -s -o $@ $^ /usr/lib/libc.a
+	$(CC) -shared -o $@ $^
+
...
diff -ruN anet/src/linux/uudp/ddprint.h anet.linux/src/linux/uudp/ddprint.h
--- anet/src/linux/uudp/ddprint.h	Wed Dec 31 16:00:00 1969
+++ anet.linux/src/linux/uudp/ddprint.h	Sat Apr 10 13:29:26 1999
@@ -0,0 +1,48 @@
+/*--------------------------------------------------------------------------
+ DDPrint.h
+ 
...
+
+#endif // _DDPrint_h_
diff -ruN anet/src/linux/uudp/uudps.c anet.linux/src/linux/uudp/uudps.c
--- anet/src/linux/uudp/uudps.c	Wed Mar 10 04:01:45 1999
+++ anet.linux/src/linux/uudp/uudps.c	Sat Apr 10 13:20:30 1999
@@ -54,14 +54,17 @@
