...
#define DP_ALIAS(type,name1,name2) union { type name1; type name2; } PACK
#define DP_ALIAS3(type,name1,name2,name3) union { type name1; type name2; type name3; } PACK
#else
...
----------------------------------------------------------------------*/
DP_API ptrdiff_t DP_APIX dp_unpack_session(dp_t *dp, const char *subkey, int subkeylen, const unsigned char *buf, ptrdiff_t buflen, dp_session_t *p);
